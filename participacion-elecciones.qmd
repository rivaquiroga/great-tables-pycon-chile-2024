...
Este fue el código utilizado para la versión final del primer ejemplo mostrado durante la charla. Además de polars, cargamos los selectores incluidos en esa biblioteca.
...
(
    GT(participacion)
    .cols_hide(columns=["mesas", "electores"])
    .tab_header(
